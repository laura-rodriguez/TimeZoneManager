...
namespace TimeZoneManager.Web
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/Helpers").IncludeDirectory("~/Scripts/Helpers", "*.js"));
            bundles.Add(new ScriptBundle("~/bundles/ViewModels").IncludeDirectory("~/Scripts/ViewModels", "*.js"));
